...
data AstNode	= compilationUnit(AstNode package, list[AstNode] imports, list[AstNode] typeDeclarations)
				...
				| classInstanceCreation(Option[AstNode] optionalExpression, TypedAstNode \type, list[AstNode] genericTypes, list[AstNode] arguments, Option[AstNode] anonymousClassDeclaration)
				...
				| methodInvocation(Option[TypedAstNode] optionalExpression, list[TypedAstNode] genericTypes, str name, list[TypedAstNode] arguments)
