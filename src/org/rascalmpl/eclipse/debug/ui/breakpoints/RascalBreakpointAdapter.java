...
public class RascalBreakpointAdapter implements IToggleBreakpointsTargetExtension {
	...
	public void toggleLineBreakpoints(IWorkbenchPart part, ISelection selection) throws CoreException {
		...
		if (textEditor != null) {
			...
			ISourceLocation loc = ProjectURIResolver.constructProjectURI(resource.getFullPath());
			loc = IRascalValueFactory.getInstance().sourceLocation(loc, offset, length, lineNumber + 1, lineNumber + 1, 0, 0);
			RascalSourceLocationBreakpoint lineBreakpoint = new RascalSourceLocationBreakpoint(resource, loc);
