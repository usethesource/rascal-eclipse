...
public class HyperlinkDetector implements ISourceHyperlinkDetector {
	...
	public IHyperlink[] detectHyperlinks(IRegion region, ITextEditor editor,
		...
		Tree tree = (Tree) parseController.getCurrentAst();
	...
	private IHyperlink[] getTreeLinks(Tree tree, IRegion region) {
		...
		Tree ref = TreeAdapter.locateAnnotatedTree(tree, "link", region.getOffset());
		...
		Tree subtree = TreeAdapter.locateAnnotatedTree(tree, "loc", region.getOffset());
